# Cozy Tech Pack: install guide for friends
...
3. Download the pack file Josh sent you (`CozyTech.zip`). Don't unzip it.
4. In Prism: **Add Instance** > **Import** > pick the zip. Click OK.
5. Select the instance, click **Edit** > **Settings**, and set memory to at least **3500 MB** max (4096 if your machine has 16 GB).
...
## If it won't start
- Make sure memory is set to at least 3500 MB.
